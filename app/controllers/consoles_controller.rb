class ConsolesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @console.save
        format.html { redirect_to console_url(@console), notice: "Console was successfully created." }
  ...
  def update
    respond_to do |format|
      if @console.update(console_params)
        format.html { redirect_to console_url(@console), notice: "Console was successfully updated." }
  ...
  private
    ...
    def console_params
      params.require(:console).permit(:name, :manufacturer, :colour, :price, :status, :stock)
    end
end
