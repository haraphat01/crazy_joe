...
class ConsolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create console" do
    assert_difference("Console.count") do
      post consoles_url, params: { console: { colour: @console.colour, manufacturer: @console.manufacturer, name: @console.name, price: @console.price, status: @console.status, stock: @console.stock } }
    end
  ...
  test "should update console" do
    patch console_url(@console), params: { console: { colour: @console.colour, manufacturer: @console.manufacturer, name: @console.name, price: @console.price, status: @console.status, stock: @console.stock } }
